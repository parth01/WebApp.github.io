...
const medicineButton = document.getElementById('medicine') as HTMLButtonElement;
const pageTitle = document.getElementById('pageTitle') as HTMLHeadingElement;
const vaccinationButton = document.getElementById('vaccination') as HTMLButtonElement;
const disinfectButton = document.getElementById('disinfect') as HTMLButtonElement;
const batchNumberInput = document.getElementById('batchNumberInput') as HTMLInputElement;
...
function initializeItems(items: { name: string; quantity: number; rate: number }[]) {
    clearTable();
